/* from https://cdn.jsdelivr.net/npm/leaflet-image@0.4.0/leaflet-image.js, but with some edits
got rid of usage of addCacheString() function and its usage
which was forcing a reload of all the tile images even though they were already loaded on the page
*/
...
module.exports = function leafletImage(map, callback) {
    ...
    function handleEsriDymamicLayer(dynamicLayer, callback) {
        ...
        im.src = dynamicLayer._currentImage._image.src;
