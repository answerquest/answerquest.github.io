function selfrefCSV_2_hierarchHTML(csvFile, params) {
/*
...
*/                  
				...
				*/
				if(numkids) output = '<li><label class="tree-toggler nav-header list-group-item">' + thisrow[0][nameField] + '</label> <ul class="nav nav-list tree">';
				else output = '<li class="list-group-item"><a href="#" rel="menu">' + thisrow[0][nameField] + '</a></li>';
			...
			else destination.value = finalOutput; 
			destination.focus();
		}
		
} // selfrefCSV_2_hierarchHTML function over
